...
import { clearScans, getScans, } from "../services/scanService.js";
const router = Router();
/*
 * GET /api/scans
 *
...
router.get("/", (req, res) => {
    try {
        ...
        console.error("Unable to retrieve scans:", error);
        return res
            .status(500)
            .json({
...
router.delete("/", (_req, res) => {
    try {
        ...
        console.error("Unable to clear scans:", error);
        return res
            .status(500)
            .json({
            error: "Unable to clear scan history.",
        });
    }
});
