...
app.get("/", (_request, response) => {
    response.json({
        name: "Sentri API",
        version: "1.0.0",
        message: "Rule-based scam and suspicious-link detection backend.",
        endpoints: {
            health: "GET /api/health",
            analyzeMessage: "POST /api/analyze",
            analyzeUrl: "POST /api/analyze-url",
            scanHistory: "GET /api/scans",
            clearScanHistory: "DELETE /api/scans",
...
app.listen(port, () => {
    ...
    console.log("History:  GET /api/scans");
    console.log("Clear:    DELETE /api/scans");
